this.moss_item <- this.inherit("scripts/items/supplies/food_item", {
	m = {},
	function create()
	{
		this.food_item.create();
		this.m.ID = "supplies.moss";
		this.m.Name = "Moss";
		this.m.Description = "Provisions. Wet, muddy and mossy. Eating this may seem risky, but some people likes to eat strange things.";
		this.m.Icon = "supplies/inventory_provisions_moss.png";
		this.m.Value = 60;
