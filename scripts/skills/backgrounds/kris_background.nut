this.kris_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	m = {},
	function create()
	{
		this.character_background.create();
		this.m.ID = "kris_background";
		this.m.Name = "Kris";
		this.m.Icon = "ui/backgrounds/Kris_background.png";
		this.m.BackgroundDescription = "Kris, Human from prophecy";
		this.m.GoodEnding = " %name% returned to home in one piece. It spent the money it earned on a comfortable life.";
		this.m.BadEnding = "%name% returned to home in one piece. Unfortunately for it, it lost it money and was grounded by Toriel";
		this.m.HiringCost = 5;
		this.m.DailyCost = 10;
		this.m.Excluded = [
			"trait.weasel",
